...
const Portfolio = () => {
  ...
  return (
    <>
      {/* <section className="portfolio" data-aos="fade-up" data-aos-duration={3000}>
        <div className="shape" />
              ...
              <div className="portfolio__left">
                <div className="portfolio-box">
                  ...
                  <div className="icon">
                    ...
                    >
                      <path
                        d="M9.625 27.0312L1.11516 25.1201L0.25 22.3438L9.625 17.6562L19 22.3438L18.0232 25.1759L9.625 27.0312Z"
                        fill="#1DE8F1"
                      />
                      <path
                        d="M9.625 40L0.25 35.3125V22.3438L9.625 27.0312L11.9688 30.4808V36.632L9.625 40Z"
                        fill="#00D0FF"
                      />
                      <path
                        d="M19 35.3125L9.625 40V27.0312L19 22.3438V35.3125Z"
                        fill="#00BBFF"
                      />
                      <path
                        d="M28.375 27.0312L19.8652 25.1201L19 22.3438L28.375 17.6562L37.75 22.3438L36.7732 25.1759L28.375 27.0312Z"
                        fill="#B9A2FF"
                      />
                      <path
                        d="M28.375 40L19 35.3125V22.3438L28.375 27.0312L30.7188 30.4808V36.632L28.375 40Z"
                        fill="#865FFF"
                      />
                      <path
                        d="M37.75 35.3125L28.375 40V27.0312L37.75 22.3438V35.3125Z"
                        fill="#5C27FE"
                      />
                      <path
                        d="M19 9.375L10.4902 7.46383L9.625 4.6875L19 0L28.375 4.6875L27.3982 7.51961L19 9.375Z"
                        fill="#7986E8"
                      />
                      <path
                        d="M19 22.3438L9.625 17.6562V4.6875L19 9.375L21.3438 12.7464V18.9757L19 22.3438Z"
                        fill="#6E77E5"
                      />
                      <path
                        d="M28.375 17.6562L19 22.3438V9.375L28.375 4.6875V17.6562Z"
                        fill="#4C5CE1"
                      />
                    </svg>
                  </div>
